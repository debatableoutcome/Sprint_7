...
from helpers.orders import create_order, cancel_order, accept_order, get_order_by_track
...
class TestAcceptOrder:
    ...
    def test_accept_order_success_returns_ok(self, created_courier):
        track = None
    ...
    def test_accept_order_with_wrong_courier_id_returns_error(self):
        response = accept_order(order_id=123456, courier_id=999999999)
